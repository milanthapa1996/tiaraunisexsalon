    ...
    <div className="max-w-5xl mx-auto px-4">
      <div className="container mx-auto py-12 px-4">
        ...
        <ul className="list-disc list-inside mb-6 space-y-2">
          <li>
            <strong className="font-semibold">Account:</strong> A unique account
            created for You to access our Service or parts of our Service.
          </li>
          <li>
            <strong className="font-semibold">Affiliate:</strong> An entity that
          ...
          <li>
            <strong className="font-semibold">Company:</strong> The Tiara Unsex
            Salon Pvt. Ltd., Bafal-13, Kathmandu, Nepal, 4600.
          </li>
          <li>
            <strong className="font-semibold">Cookies:</strong> Small files that
          ...
          <li>
            <strong className="font-semibold">Country:</strong> Nepal
          </li>
          <li>
            <strong className="font-semibold">Device:</strong> Any device that
            can access the Service such as a computer, a cellphone, or a digital
            tablet.
          </li>
          <li>
            <strong className="font-semibold">Personal Data:</strong> Any
            information that relates to an identified or identifiable
            individual.
          </li>
          <li>
            <strong className="font-semibold">Service:</strong> The Website.
          </li>
          <li>
            <strong className="font-semibold">Service Provider:</strong> Any
          ...
          <li>
            <strong className="font-semibold">Usage Data:</strong> Data
          ...
          <li>
            <strong className="font-semibold">You:</strong> The individual
        ...
        <ul className=" mb-4 space-y-2">
          ...
          <li className="text-base text-gray-700">&bull; Email address</li>
          <li className="text-base text-gray-700">
            &bull; First name and last name
          </li>
          <li className="text-base text-gray-700">&bull; Phone number</li>
          <li className="text-base text-gray-700">&bull; Usage Data</li>
        </ul>
        ...
        <ul className="space-y-2">
          <li className="text-base text-gray-700">
            &bull; <strong>Cookies or Browser Cookies</strong>. A cookie is a
          ...
          <li className="text-base text-gray-700">
            &bull; <strong>Web Beacons</strong>. Certain sections of our Service
        ...
        <div className="container mx-auto py-8 px-4">
          ...
          <h2 className="text-2xl font-semibold mb-4">Functionality Cookies</h2>
          <p className="mb-4">Type: Persistent Cookies</p>
          <p className="mb-4">Administered by: Us</p>
          <p className="mb-4">
        ...
        <h3 className="mb-2">Disclosure of Your Personal Data</h3>
        ...
        <ul className="list-disc list-inside">
          <li className="text-base text-gray-700">
            By email: tiaraunisexsalon@gmail.com
          </li>
        </ul>
      </div>
    </div>
